...
public class TestReflection {
	...
	public void test5() throws Exception{
		...
		ClassLoader loader6 = clazz3.getClassLoader();
		System.out.println(loader6);
		
		//掌握如下
		//法一：
		ClassLoader loader = this.getClass().getClassLoader();
		System.out.println(loader);
		InputStream is = loader.getResourceAsStream("reflect\\jdbc.properties");
		//法二：
//		FileInputStream is = new FileInputStream(new File("file/jdbc.properties"));
...
//		Class clazz1 = String.class;
		...
		Object value = m2.invoke(p,"CHN",10);
