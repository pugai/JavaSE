...
public class TestTCP3 {
	...
	public void client()throws Exception{
		...
		FileInputStream fis = new FileInputStream(new File("image/1.jpg"));
		...
		while((len1 = is.read(b1)) != -1){
			String str = new String(b1,0,len1,"UTF-8");
	...
	public void server() throws Exception{
		...
		FileOutputStream fos = new FileOutputStream(new File("image/4.jpg"));
		byte[] b = new byte[1024];
		int len;
		...
		os.write("你发送的图片我已接收成功！".getBytes("UTF-8"));
